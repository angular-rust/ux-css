...
use crate::sassengine::sass::{SassString, Value};
use crate::sassengine::value::{ListSeparator, Number, Numeric, Operator, Rgba};
use nom::branch::alt;
...
mod test {
    ...
    use crate::sassengine::sass::Value::*;
    use crate::sassengine::value::Rational;
    ...
    #[test]
    fn parse_extended_literal() -> Result<(), crate::sassengine::SassError> {
        assert_eq!(
    ...
    #[test]
    fn parse_extended_literal_in_arg() -> Result<(), crate::sassengine::SassError> {
        assert_eq!(
    ...
    #[test]
    fn parse_extended_literal_in_arg_2() -> Result<(), crate::sassengine::SassError> {
        assert_eq!(
