...
///     fn find_file(
///         &self, name: &str
///     ) -> Result<Option<(Self, String, Self::File)>, SassError> {
...
impl FileContext for FsFileContext {
    ...
    fn find_file(
        &self,
        name: &str,
    ) -> Result<Option<(Self, String, Self::File)>, crate::sassengine::SassError> {
                ...
                for name in &[
                    ...
                    if full.is_file() {
                        ...
                        return match Self::File::open(full) {
                            ...
                            Err(e) => Err(SassError::Input(path, e)),
                        };
                    }
                }
            }
