...
[![](https://dudochkin-victor.github.io/assets/star-me-wide.svg)](https://github.com/angular-rust/ux-css)
...
```
git clone git@github.com:$USER/ux-css.git
```

where `$USER` is your GitHub username. Here you're copying the contents of the `ux-css` repository on GitHub to your computer.
